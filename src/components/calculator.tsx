...
const sliderConfigs: Record<string, SliderConfig> = {
  ...
  cpl: {
    ...
    hint: "How many contacts to generate 1 positive reply",
    min: 50,
    max: 1000,
    step: 10,
    defaultValue: 400,
  ...
  close: {
    label: "Close rate",
    hint: "% of calls that close into a deal",
    min: 5,
    max: 50,
    step: 5,
    defaultValue: 15,
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted max-w-lg mx-auto">
            See what AI-powered outbound could do for your pipeline. Adjust the
            inputs to match your business.
          </p>
        </motion.div>
